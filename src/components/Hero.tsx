...
const CONTENT = {
  ...
  headingLine3: "for Impact",
  description: "Helping enterprises, public agencies, and NGOs implement programs that deliver real-world results through data-driven insights and digital systems.",
...
const STYLES = {
  ...
  sectionWidth: "w-[85%] mx-auto",
  panelRatio: "grid-cols-1 lg:grid-cols-[1.6fr_1fr]", // Left panel is 1.6x wider
...
const Hero = () => {
  return (
    <section className="min-h-screen w-full flex flex-col bg-white pt-10 pb-16">
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-[1.6fr_1fr] gap-4 lg:gap-8 w-[85%] mx-auto">
        ...
        <div className="hero-panel-left rounded-[40px] lg:rounded-[60px] flex flex-col justify-start items-start overflow-hidden">
          ...
          <div className="w-full pt-32 pl-16 md:pt-40 md:pl-32 lg:pt-56 lg:pl-56 pb-16 pr-12 md:pr-16">
        ...
        {/* RIGHT PANEL */}
        <div className="hero-panel-right rounded-[40px] lg:rounded-[60px] flex flex-col justify-start items-start text-left overflow-hidden">
          <div className="w-full h-full flex flex-col justify-between pt-32 pl-12 md:pt-40 md:pl-24 lg:pt-56 lg:pl-32 pr-8 lg:pr-16 pb-16">
            ...
            {/* Bottom Content: Est Tag */}
            <div className="pt-20 hidden lg:flex items-center gap-6 mt-auto">
              <div className="h-[3px] w-16 bg-black"></div>
              <span className="text-xs uppercase tracking-[0.6em] text-black font-black">
                  {CONTENT.bottomTag}
              </span>
            </div>
